...
from .models import Product,DetailProduct,System,Phone , Comment,Pooshak,DetailPooshak,Oven,Bag,Cover,Laundry,TV,Refrigerator,Categorize_Products,ImageCategorize,ImageProduct,BrandProduct,Hea
